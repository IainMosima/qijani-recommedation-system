...
retriever_prompt = PromptTemplate(
    ...
    Rules:
	•	If any field is an empty array `[]`, or unspecified, substitute it with a realistic, healthy default.
...
NB:
Make sure that the JSON object is valid and follows the structure specified in the example.
